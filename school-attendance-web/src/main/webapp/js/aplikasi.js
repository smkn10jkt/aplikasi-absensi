angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
        $routeProvider
            ...
            .when('/notifications/sms', {templateUrl: 'pages/notifications/sms.html', controller: 'SmsController'})
            ...
            .when('/school/class', {templateUrl: 'pages/school/class.html'})
            ...
            .when('/master/users', {templateUrl: 'pages/master/users.html'})
            .when('/master/enroll', {templateUrl: 'pages/master/enroll.html'})
            .when('/master/time', {templateUrl: 'pages/master/time.html'})
